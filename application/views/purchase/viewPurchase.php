                ...
                <div class="invoice p-3 mb-3">
                  <div id="print">
                    ...
                    <div class="row invoice-info">
                      ...
                      <div class="col-sm-4 col-4 invoice-col">
                        <b>Memo No. # <?php echo $purchase['memoNo']; ?></b><br>
                        <b>Order Date :</b> <?php echo date('d-m-Y', strtotime($purchase['puDate'])); ?>
                      </div>
                    </div>
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody style="text-align: center;">
                            <tr>
                              ...
                              <td colspan="6">( In Words&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo convertNumber($twa); ?> )</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                  ...
                  <div class="row no-print" >
                    <div class="col-12" style="text-align: center;">
                      ...
                      <a href="<?php echo site_url('workOrder'); ?>" class="btn btn-danger" ><i class="fas fa-arrow-left"></i> Back</a>
                    </div>
                  </div>
                </div>
              </div>
