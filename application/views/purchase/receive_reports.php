  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Receive Reports</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>Dashboard">Dashboard</a></li>
              <li class="breadcrumb-item active">Receive Reports</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Receive Reports</h3>
              </div>

              <div class="card-body">
                <div class="col-sm-12 col-md-12 col-12">
                  <form action="<?php echo base_url(); ?>receiveReport" method="get">
                    <div class="col-md-12 col-sm-12 col-12">
                  ...
                  <div id="print">
                    ...
                    <?php 
                        ...
                        if(isset($_GET['search'])) {
                            $supName = $this->db->select('supName')
                                                ->from('suppliers')
                                                ->where('supid', $supid)
                                                ->get()
                                                ->row();
                    ...
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b><?php if(isset($supName)){ echo $supName->supName; } ?> Reports in : <?php echo $sdate.' To '.$edate; ?></b></h3>
                    </div>
                    <?php } else if ($report == 'monthlyReports') { ?>
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b><?php if(isset($supName)){ echo $supName->supName; } ?> Reports in : <?php echo $name.' To '.$year; ?></b></h3>
                    </div>
                    <?php } else if ($report == 'yearlyReports') { ?>
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b><?php if(isset($supName)){ echo $supName->supName; } ?> Reports in : <?php echo $year; ?></b></h3>
                    </div>
                    <?php } } ?>
                    ...
                    <div class="col-sm-12 col-md-12 col-12">
                      <table id="example1" class="table table-striped table-bordered" >
                        ...
                        <tbody>
                          ...
                          $pp = $this->db->select('
                                        receive_product.*,
                                        receive_order.roMemo,
                                        products.pName,
                                        products.pCode')
                                  ->from('receive_product')
                                  ->join('products','products.pid = receive_product.pid','left')
                                  ->join('receive_order','receive_order.roid = receive_product.roid','left')
                                  ->where('receive_product.roid',$result->roid)
                                  ->get()
                                  ->result();
                          ?>
                          <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $result->roMemo; ?></td>
                            <td><?php echo date('d-m-Y',strtotime($result->roDate)) ?></td>
                            ...
                            <td>
                              ...
                              ?>
                              <?php echo $tdqnt; ?><hr style="padding:0;margin:0;">
                              <?php } ?>
                            </td>
                            <td>
                              <?php foreach($pp as $p){ ?>
                              <?php echo $p->quantity; ?><hr style="padding:0;margin:0;">
                              <?php } ?>
                            </td>
