        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo site_url("Product/update_store_product"); ?>">
                  <input type="hidden" name="spid" value="<?php echo $store['spid']; ?>" required >
                  <div class="col-md-12 col-sm-12 col-12">
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="form-group col-md-4 col-sm-4 col-12">
                        <label>Note</label>
                        <input type="text" class="form-control" name="notes" value="<?php echo $store['notes']; ?>" placeholder="If have any note" >
                      </div>
                    </div>             
